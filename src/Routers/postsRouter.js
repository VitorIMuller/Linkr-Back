...
import { createPosts, deletePost, editPost, getTotalReposts, listPostByHashtag, listPostByUserId, listPosts, reposts } from "../Controllers/postsController.js";
...
postsRouter.get("/posts/reposts/:postId/total", getTotalReposts);
